      ...
      ** scratch space grid */
      ...
      if (obstacles[jj * params.nx + ii])
      {
        ...
        ** mirroring, and writing into main grid */
        float tmp1 = tmp_cells[ii + jj * params.nx].speeds[1];
        float tmp2 = tmp_cells[ii + jj * params.nx].speeds[2];
        float tmp6 = tmp_cells[ii + jj * params.nx].speeds[6];
        float tmp5 = tmp_cells[ii + jj * params.nx].speeds[5];
        ...
        tmp_cells[ii + jj * params.nx].speeds[3] = tmp1;
        tmp_cells[ii + jj * params.nx].speeds[4] = tmp2;
        ...
        tmp_cells[ii + jj * params.nx].speeds[7] = tmp5;
        tmp_cells[ii + jj * params.nx].speeds[8] = tmp6;
      }
      ...
      if (!obstacles[ii + jj * params.nx])
      {
        ...
        for (int kk = 0; kk < NSPEEDS; kk++)
        {
          ...
          local_density_av += tmp_cells[ii + jj * params.nx].speeds[kk];
        }
        ...
        float u_x_av = (tmp_cells[ii + jj * params.nx].speeds[1] + tmp_cells[ii + jj * params.nx].speeds[5] + tmp_cells[ii + jj * params.nx].speeds[8] - (tmp_cells[ii + jj * params.nx].speeds[3] + tmp_cells[ii + jj * params.nx].speeds[6] + tmp_cells[ii + jj * params.nx].speeds[7])) / local_density;
        /* compute y velocity component */
        float u_y_av = (tmp_cells[ii + jj * params.nx].speeds[2] + tmp_cells[ii + jj * params.nx].speeds[5] + tmp_cells[ii + jj * params.nx].speeds[6] - (tmp_cells[ii + jj * params.nx].speeds[4] + tmp_cells[ii + jj * params.nx].speeds[7] + tmp_cells[ii + jj * params.nx].speeds[8])) / local_density;
